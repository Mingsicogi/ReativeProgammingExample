...
public class Operator {
	...
	public static void main(String[] args) {
		...
		Publisher<Integer> mapPub = mapPub(getPublisher(iter), (Function<Integer, Integer>) num -> num * 10);
		Publisher<Integer> mapPub2 = mapPub(mapPub, (Function<Integer, Integer>) num -> num * 10);
